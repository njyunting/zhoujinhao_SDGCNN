...
parser.add_argument('--num_supervoxels', type=int, default=4096, help='supervoxel number [default: 4096]')
parser.add_argument('--max_epoch', type=int, default=100, help='Epoch to run [default: 100]')
parser.add_argument('--batch_size', type=int, default=5, help='Batch Size [default: 24]')
...
def train_one_epoch(sess, tra_set, tra_generator, ops):
    ...
    print(f'Number of training batches: {num_batches}')  # 输出批次数
    ...
    # 检查是否为零
    if num_batches == 0:
        log_string("No batches to process. Check your training data.")
        return

    if total_seen_training == 0:
        log_string("No training samples seen. Check your batch size and data.")
        return
